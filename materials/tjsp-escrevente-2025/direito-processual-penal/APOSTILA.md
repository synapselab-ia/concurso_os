...
**Versão:** `0.1.0-rc.2`  
**Status:** release candidate corrigido; conteúdo jurídico congelado do `0.1.0-draft.3`; novo PDF e smoke regressivo ainda necessários  
...
| Ponto | Ordinário | Sumário |
|---|---:|---:|
| pena máxima de referência | igual ou superior a 4 anos | inferior a 4 anos, fora do sumaríssimo |
...
suspensão condicional do processo -> 2 a 4 anos
```
