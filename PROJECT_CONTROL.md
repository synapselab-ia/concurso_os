...
- **Current pack:** `direito-penal` — autorizado para autoria; redação ainda não iniciada
...
- **Next Gate:** Gate 5 — iniciar autoria de `direito-penal` usando `DP-01`…`DP-10` como contrato
