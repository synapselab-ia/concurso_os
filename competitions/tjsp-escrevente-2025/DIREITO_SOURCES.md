# DIREITO B2 — Inventário de fontes normativas

**Competition:** `tjsp-escrevente-2025`  
**Syllabus block:** B2 — Conhecimentos em Direito  
**Status:** `in_progress`  
**Edital authority:** `SRC-TJSP-EDITAL-2025-02`  
**Edital publication cutoff recorded in the adapter:** `2025-07-29`  
**Inventory verification date:** `2026-09-11`

## Regra de versão

O edital determina legislação com alterações e atualizações vigentes até a publicação do edital e admite legislação posterior quando superveniente ou complementar a tópico previsto ou indispensável à avaliação.
...
| source_id | Diploma | Recorte do edital | Autoridade / proveniência oficial | Estado de versão |
|---|---|---|---|---|
| `SRC-B2-L10261` | Lei Estadual n.º 10.261/1968 — Estatuto dos Funcionários Públicos Civis do Estado | arts. 1–86; 171–175; 239–323 | ALESP — `https://www.al.sp.gov.br/repositorio/legislacao/lei/1968/lei-10261-28.10.1968.html` | `drift_confirmed` — página atual informa alteração em 03/06/2026; também registra alteração de 23/12/2025. Reconstruir snapshot de 2025-07-29 antes da autoria |
| `SRC-B2-RES850` | Resolução TJSP n.º 850/2021 — teletrabalho | integral | TJSP — `https://esaj.tjsp.jus.br/gcn-frontend-vue/legislacao/find/196070` | `candidate_closed` — fonte oficial informa texto compilado/original e atualização em 25/04/2022; ainda conferir histórico até o cutoff |
| `SRC-B2-RES963` | Resolução TJSP n.º 963/2025 — eproc | integral | TJSP — `https://esaj.tjsp.jus.br/gcn-frontend-vue/legislacao/find/229313` | `candidate_closed` — DJE de 29/05/2025, anterior ao cutoff; conferir atos alteradores antes de congelar |
| `SRC-B2-LC1111` | Lei Complementar Estadual n.º 1.111/2010 — Plano de Cargos e Carreiras | integral | ALESP — `https://www.al.sp.gov.br/repositorio/legislacao/lei.complementar/2010/compilacao-lei.complementar-1111-25.05.2010.html` | `drift_confirmed` — compilação atualizada até 05/05/2026 e histórico registra alteração em 23/12/2025; reconstruir snapshot de 2025-07-29 |
| `SRC-B2-RITJSP` | Regimento Interno do TJSP | integral | TJSP — `https://www.tjsp.jus.br/Download/Portal/Biblioteca/Biblioteca/Legislacao/RegimentoInternoTJSP.pdf` | `drift_confirmed` — PDF oficial disponível hoje está atualizado em 2026; localizar/validar versão vigente em 2025-07-29 |
| `SRC-B2-NSCGJ-T1` | Normas Judiciais da Corregedoria-Geral da Justiça — Tomo I | somente recortes do edital | TJSP — `https://www.tjsp.jus.br/Corregedoria/Comunicados/NormasJudiciais` | `drift_confirmed` — página atual oferece Tomo I atualizado até 03/07/2026; localizar/validar snapshot de 2025-07-29 e resolver anomalia textual do edital sem inferência |

## Recorte literal das NSCGJ no edital

O edital imprime:

1. Tomo I — Capítulo II — Seção I — subseções I e II;
2. Tomo I — Capítulo III — Seções I, II, V, VI e VII;
3. Tomo I — Capítulo III — Seção VIII — subseções I, II e III;
4. Tomo I — Capítulo III — Seções IX a XIX;
5. Tomo I — Capítulo XI — Seções I, IV e V;
6. Tomo I — Capítulo XI — Seções I a VII.

O item 6 repete o Capítulo XI. Isso é tratado como **anomalia da fonte oficial**, não como permissão para corrigir por suposição.

## Provas usadas apenas como evidência empírica

Estas fontes não definem o texto jurídico vigente, mas serão usadas no Gate 3:
...
- [ ] reconstruir versão de 2025-07-29 da LC Estadual n.º 1.111/2010;
- [ ] localizar/validar Regimento Interno vigente em 2025-07-29;
...
Conforme DEC-0011, binários-fonte de terceiros não são copiados para o repositório público. O repositório mantém identidade, autoridade, URL, recorte, data/versão e hash/tamanho quando um arquivo estável é usado localmente.
